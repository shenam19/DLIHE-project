      ...
      <div className="w-4/5 ml-32 mt-16">
        ...
        <div className="w-full min-h-30 pl-1 mb-10">
          <p>
            ...
            Institute. It provides comfortable resident facilities for students
            and faculty members. DLIHE has well-planned infrastructure and very
            qualified faculty members to run the programs. Its programs are
            unique and a rarity in the world. The following Councils and Bodies
            help in its planning, development, and management process. The DLIHE
            has a Governing Council, Academic Advisory Council, Managing
            Council, Academic Council, and the Examination Committees who meet
            periodically to discuss policy and the Institute’s regulation
            matters.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="h-50 pl-1 text-left">
            The Presidential Office is the central hub of the organization with
            executive power for overall responsibility to oversee and ensure the
            smooth functioning of all TCV units with necessary coordination,
          ...
          <p className="h-50 pl-1 text-left mb-12">
            Managing Council is the apex body for Academic Policy decisions. As
            per the Memorandum of Understanding, members comprise of officials
            both from the University of Mysore and the DLIHE as follows:
          </p>
        </div>
        ...
        <div id="base" className="pl-5 mb-10 text-2xl font-light">
          <p>
            ...
            This council emerged with a resolution of the Executive Council. It
            functions with the chairman and the Principal of the institute as
            the member Secretary. The TCV Head Office nominates the other
