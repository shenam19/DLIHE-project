...
const Academic = () => {
  return (
    <div className=" pt-[200px] mb-20">
      ...
      <div>
        <p className=" parabox text-center mx-auto mt-10 text-[20px] w-[65%] font-extralight">
        ...
        <p className=" parabox mx-auto text-center mt-10 text-[20px] w-[65%] font-extralight">
